...
static const char *fonts[]          = { "FiraCode Nerd Font:size=12" , "FontAwesome:size=12", "monospace:size=12"};
static const char dmenufont[]       = "FiraCode Nerd Font:size=12";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#1b5e20"; /* material dark green */
...
static const Layout layouts[] = {
	...
	{ "---",      horizgrid },
	{ ":::",      gaplessgrid },
	{ NULL,       NULL} /* don't remove from end, this is required for cyclelayout patch */
};
...
static const char *printscreencmd[] = {"scrot", "-d3", "/home/ashutosh/Pictures/screenshots/%Y-%m-%d_%H:%M:%S.jpg", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_i,      incnmaster,     {.i = +3 } },
	{ MODKEY,                       XK_d,      incnmaster,     {.i = -3 } },
    ...
    { MODKEY|ShiftMask,             XK_p,      spawn,          {.v = printscreencmd } },
};
